    ...
    <motion.div className="hero-content" variants={staggerContainer} initial = "initial" animate= "animate">
     ...
     Muhamad Uzair Imam
      ...
      <motion.p className="hero-description"  variants={fadeInUp}>
         Full Stack Engineer with a strong problem-solving mindset and a passion for continuous learning. Dedicated to exploring emerging technologies and building impactful real-world applications.
      </motion.p>
       ...
       <motion.div className="cta-buttons" variants={staggerContainer}>
          ...
          <motion.div className="social-links" variants={staggerContainer}>
            ...
            <motion.a href="https://www.linkedin.com/in/muhammad-uzair-imam-b29934372/" target="_blank">
